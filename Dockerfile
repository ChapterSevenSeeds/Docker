...
SHELL ["/bin/bash", "-c"]
RUN apt-get update
RUN apt-get install ffmpeg bc imagemagick sudo git tmux curl dos2unix wget jq build-essential libssl-dev nano yt-dlp unzip python3.13 python3.13-venv -y
